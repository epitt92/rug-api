...
class RugAPIException(Exception):
    ...
    """
    def __init__(self, message: str = "An exception occurred while calling an external rug.ai endpoint."):
...
class DatabaseLoadFailureException(Exception):
    ...
    """
    def __init__(self, message="An exception occurred while attempting to fetch data from DynamoDB."):
        super().__init__(message)
...
class DatabaseInsertFailureException(Exception):
    ...
    """
    def __init__(self, message="An exception occurred while attempting to insert data into DynamoDB."):
        super().__init__(message)
