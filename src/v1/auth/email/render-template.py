...
if __name__ == '__main__':
    print(render_template('referral-invite.html',
                          title="You've Been Invited!",
                          username='John',
                          referer='Jane',
                          url='https://rug.ai'))

    print(render_template('otp.html',
                          title="OTP",
                          username="John",
                          code="123 456",
                          url="https://Rug.ai"))

    print(render_template('reset-password.html',
                          title="You've Requested to Reset Your Password",
                          username="RugEnjoyer",
                          reset_link="https://rug.ai/reset-pwd?username=xxxxx&code=123456"))

    print(render_template('join-waitlist.html',
                          title="Thanks for Joining the Waitlist!"))

    print(render_template('welcome.html',
                          title="Welcome to Rug.ai",
                          url="https://Rug.ai/signup?ref=123456"))

    print(render_template('airdrop.html',
    ...
    print(render_template('password-reset-successfully.html',
