...
ANTI_WHALE_MAPPING = {
    True: {
        "title": "Has Anti-Whale Functionality",
    ...
    False: {
        "title": "Does Not Have Anti-Whale Functionality",
...
HIDDEN_OWNER_MAPPING = {
    ...
    False: {
        "title": "Does Not Have Hidden Owner",
...
OWNER_CHANGE_BALANCE_MAPPING = {
    ...
    False: {
        "title": "Owner Cannot Change Balance",
...
SELF_DESTRUCT_MAPPING = {
    True: {
        "title": "Contract Has Self Destruct OP Code",
    ...
    False: {
        "title": "No Self Destruct OP Code",
...
CLUSTERING_REPORT_STALENESS_THRESHOLD = 60 * 60 * 6  # 6 hours
HOLDERS_STALENESS_THRESHOLD = 60 * 60 * 6  # 6 hours
